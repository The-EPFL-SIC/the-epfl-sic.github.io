...
function Companies() {
    ...
    useEffect(function() {
        window.scrollTo(0, 0);
        document.title = `${(lang === "FR")? "entreprises" : "companies"} | EPFL Sustainable Innovation Challenge`;
    }, [])
        ...
        "timeline": {
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "text": {
                        "FR": "Rejoignez-nous les 13 et 14 mars sur le campus de l'EPFL à Lausanne, en Suisse - obtenez votre stand et présentez vos recherches, tout en réseautant avec des étudiants talentueux, des partenaires industriels, des chercheurs et des experts, et acquérez de nouvelles perspectives lors de l'expo scientifique.",
